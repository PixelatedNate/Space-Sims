...
public class Alert
{
    ...
    public Alert(string name, string message, UnityAction onClickEffect, AlertPrority prority, UIIcons icons)
    {
        this.name = name;
        this.message = message;
        this.OnClickEffect = onClickEffect;
        this.prority = prority;
        time = DateTime.Now;
        AlertIcon = Icons.GetMiscUIIcon(icons);
    }
    ...
    public Alert(string name, string message, AlertPrority prority, UIIcons icons)
    {
        this.name = name;
        this.message = message;
        this.prority = prority;
